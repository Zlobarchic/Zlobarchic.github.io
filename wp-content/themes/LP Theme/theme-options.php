	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Форма  обратной связи', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[sendtext]" class="regular-text" type="text" name="sample_theme_options[sendtext]" value="<?php esc_attr_e( $options['sendtext'] ); ?>" />
					</td>
				</tr>
